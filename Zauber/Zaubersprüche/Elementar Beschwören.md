...
Geste: true
Material: true
Materialkosten: brennender Weihrauch für Luft, weicher Lehm für Erde, Schwefel und Phosphor für Feuer oder Wasser und Sand für Wasser
Dauer: 1 Stunde
Konzentration: true
Ritual: false
Skalierbar: true
...
Der Elementar ist für die Wirkungsdauer mit dir und deinen Gefährten verbündet. Würfle die Initiative für den Elementar, da er eigene Züge ausführt. Dein elementarer Diener folgt allen verbalen Befehlen, die du ihm erteilst (dazu musst du keine [[Aktion]] aufwenden). Ohne Befehl verteidigt er sich gegen feindliche Kreaturen, führt aber ansonsten keine [[Aktion|Aktionen]] aus.
...
## Auf höheren Graden
Wenn du diesen Spruch mit einem [[Zauberplätze|Zauberplatz]] des 6. oder eines höheren [[Zaubergrad|Grades]] wirkst, steigt der Herausforderungsgrad des Elementars für jeden [[Zaubergrad|Grad]] über den 5. hinaus um 1.