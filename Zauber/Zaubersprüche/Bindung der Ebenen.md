...
Geste: true
Material: true
Materialkosten: ein Edelstein im Wert von mindestens 1.000 GM, der beim Wirken des Zaubers verbraucht wird
Dauer: 24 Stunden
Konzentration: false
Ritual: false
Skalierbar: true
...
## Auf höheren Graden: 
Wenn du diesen Spruch mit einem [[Zauberplätze|Zauberplatz]] eines höheren [[Zaubergrad|Grades]] wirkst, verlängert sich die Wirkungsdauer: auf 10 Tage bei einem [[Zauberplätze|Zauberplatz]] des 6. [[Zaubergrad|Grades]], auf 30 Tage bei einem des 7. [[Zaubergrad|Grades]], auf 180 Tage bei einem des 8. [[Zaubergrad|Grades]] und auf 1 Jahr und 1 Tag bei einem des 9. [[Zaubergrad|Grades]].