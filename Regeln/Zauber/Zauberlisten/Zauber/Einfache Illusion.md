...
## Beschreibung
Du erschaffst ein Geräusch oder das Abbild eines Gegenstands, das für die Wirkungsdauer bestehen bleibt. Die Illusion endet auch, wenn du sie als [[Zug#Aktion]] aufhebst oder den Zauber erneut wirkst.
...
Eine Kreatur kann ihre Aktion verwenden, um das Bildnis oder das Geräusch zu untersuchen. Gelingt ihr ein Wurf auf Intelligenz (Nachforschungen) gegen den SG zum Widerstehen deiner Zauber, kann sie erkennen, dass es sich um eine Illusion handelt.
