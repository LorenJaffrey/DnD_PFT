...
---
### Angriff
[[Nahkampfangriff|Nahkampf]] oder [[Fernkampfangriff|Fernkampf]] Angriff.
...
Bei magischen Gegenständen ist immer eine [[Aktionen|Aktion]] notwendig.

### Helfen
Einer anderen Kreatur bei einer [[Aktionen|Aktion]] in diesem Zug helfen.
...
### Rückzug
[[Bewegung]] in diesem Zug löst keinen [[Nahkampfangriff|Nahkampf#Gelegenheitsangriff]] aus.

### Spezialfähigkeit verwenden
Klassenmerkmale können Spezialfähigkeiten gewähren die den Einsatz einer [[Aktionen|Aktion]] voraussetzen.
Auch manche Monster haben Spezialfähigkeiten.

### Spurt
[[Bewegung#Bewegungsrate]] wird für diesen Zug verdoppelt.
...
### Vorbereiten
[[Aktionen|Aktion]] vorbereiten die ausgeführt wird wenn ein bestimmtes vorhersehbares Ereignis passiert.
Nur Zauber mit einem Zeitaufwand von einer [[Aktionen|Aktion]] können vorbereitet werden. Zurückhalten des Effekts erfordert jedoch Konzentration.
Wird diese unterbrochen schlägt der Zauber fehl.

### Zauber wirken
Zum Wirken der meisten Zauber ist eine [[Aktionen|Aktion]] notwendig.